...
class TenderMultiLotResourceTest(BaseTenderWebTest):
    ...
    def test_multilot_tender(self):
        ...
        self.initial_data['items'][1]['description'] = u"Сегрегатори #1"
        self.initial_data['items'][2]['description'] = u"Сегрегатори #2"
        self.initial_data['items'][3]['description'] = u"Сегрегатори #3"
        ...
        lot_values_data[0]['value']['amount'] = 800.0
        lot_values_data[0]['relatedLot'] = lots_ids[1]
        self.initial_bids[1]['lotValues'] = lot_values_data
