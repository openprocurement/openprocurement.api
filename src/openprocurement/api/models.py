...
from openprocurement.api.constants import (
    CPV_CODES, ORA_CODES, TZ, DK_CODES, CPV_BLOCK_FROM, ATC_CODES, INN_CODES
)
...
class CPVClassification(Classification):
    scheme = StringType(required=True, default=u'CPV', choices=[u'CPV', u'ДК021', u'INN', u'ATC'])
    ...
    def validate_id(self, data, code):
        ...
        elif data.get('scheme') == u'ATC' and code not in ATC_CODES:
