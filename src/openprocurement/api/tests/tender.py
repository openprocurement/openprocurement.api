...
from openprocurement.api.models import Tender, get_now, CANT_DELETE_PERIOD_START_DATE_FROM, CPV_ITEMS_CLASS_FROM, coordinates_reg_exp, ITEMS_LOCATION_VALIDATION_FROM
