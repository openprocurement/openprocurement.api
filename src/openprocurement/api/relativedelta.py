...
7. If the 'weekday' argument is present, calculate the weekday,
   ...
   (0, 1) or (0, -1) won't change the day.
    ...
    def parse_str_isoduration(self, datestring):
        ...
        return ISO8601_PERIOD_REGEX.match(datestring)

    def parse_raw_data(self, value):
        val = self.parse_str_isoduration(value)
        date = val.groups()[0:9]
        time = val.groups()[11:]
        ...
        for elem in time:
            if elem:
                if elem[-1:] == 'H':
                    ...
                    minutes = int(elem[0:-1])
                elif elem[-1:] == 'S':
                    seconds = int(elem[0:-1])
    ...
    def __init__(self, dt1=None, dt2=None,
                 ...
                 hour=None, minute=None, second=None, microsecond=None, raw_data=None):
        if raw_data:
            try:
                years, months, weeks, days, hours, minutes, seconds = self.parse_raw_data(raw_data)
    ...
    def __str__(self):
        ...
        return 'P{0}Y{1}M{2}DT{3}H{4}M{5}S'.format(
